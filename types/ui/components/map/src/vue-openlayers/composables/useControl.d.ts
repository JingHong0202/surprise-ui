...
import type { Attribution, FullScreen, MousePosition, OverviewMap, ScaleLine } from 'ol/control.js';
...
export default function useControl<T extends InnerControlType>(ControlType: new (options?: any) => T, properties: InnerControlProperties, attrs: Record<string, unknown>): {
    map: ExtentedMap | undefined;
    control: import("vue").ComputedRef<T>;
};
export {};
